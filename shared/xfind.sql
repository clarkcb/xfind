...
INSERT INTO file_name (file_type_id, name, description)
VALUES
    (5, '.bash_history', NULL),
    (5, '.bash_profile', NULL),
    (5, '.bashrc', NULL),
    (5, '.boringignore', 'Darcs'),
    (5, '.bzrignore', 'Bazaar'),
    (5, '.cfignore', 'CloudFoundry'),
    (5, '.chefignore', 'Chef'),
    (5, '.cvsignore', 'Cvs'),
    (5, '.deployignore', 'DeployHQ'),
    (5, '.distignore', 'WP-CLI'),
    (5, '.dockerignore', 'Docker'),
    (5, '.ebignore', 'ElasticBeanstalk'),
    (5, '.editorconfig', NULL),
    (5, '.eleventyignore', 'Eleventy'),
    (5, '.env', NULL),
    (5, '.eslintignore', 'ESLint'),
    (5, '.flooignore', 'Floobits'),
    (5, '.gcloudignore', 'GoogleCloud'),
    (5, '.gitattributes', NULL),
    (5, '.gitconfig', NULL),
    (5, '.gitignore', 'Git'),
    (5, '.gitkeep', NULL),
    (5, '.helmignore', 'Kubernetes Helm'),
    (5, '.hgignore', 'Mercurial'),
    (5, '.ignore', 'Sourcegraph'),
    (5, '.jpmignore', 'Jetpack'),
    (5, '.jshintignore', 'JSHint'),
    (5, '.mtn-ignore', 'Monotone'),
    (5, '.nodemonignore', 'Nodemon'),
    (5, '.npmignore', 'Npm'),
    (5, '.nuxtignore', 'NuxtJS'),
    (5, '.openapi-generator-ignore', 'OpenAPI Generator'),
    (5, '.p4ignore', 'Perforce'),
    (5, '.prettierignore', 'Prettier'),
    (5, '.profile', NULL),
    (5, '.stylelintignore', 'StyleLint'),
    (5, '.stylintignore', 'Stylint'),
    (5, '.swagger-codegen-ignore', 'SwaggerCodegen'),
    (5, '.terraformignore', 'Terraform'),
    (5, '.tfignore', 'TF'),
    (5, '.tokeignore', 'Tokei'),
    (5, '.upignore', 'Up'),
    (5, '.vercelignore', 'Vercel'),
    (5, '.viminfo', NULL),
    (5, '.yarnignore', 'Yarn'),
    (5, '.zprofile', NULL),
    (5, '.zsh_history', NULL),
    (5, '.zshenv', NULL),
    (5, '.zshrc', NULL),
    (5, 'CMakeLists.txt', NULL),
    (5, 'Dockerfile', NULL),
    (5, 'Gemfile', NULL),
    (5, 'ignore-glob', 'Fossil'),
    (5, 'Jenkinsfile', NULL),
    (5, 'Makefile', NULL),
    (5, 'MANIFEST', NULL),
    (5, 'mime.types', NULL),
